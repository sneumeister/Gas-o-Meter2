...
| --------- | --- | ----- | ------------ | --------- |
| J1 | 1 | JST-SH 1.25 2pin plug | Generic connector, single row, 01x02 | |
| J2 | 1 | JST-SH 1.25 2pin socket | Generic connector, single row, 01x02 | |
| R1 | 1 | 8,2k | Resistor_SMD1206 | |
| R2,R3 | 2 | 220k | Resistor_SMD1206 | |
